...
<form method="POST" action="{{ route('suppliers.store') }}">
  ...
  <div class="form-card">
    <div class="row2">
      <div class="field custom-autocomplete"><label>الموبايل</label><input type="tel" name="phone" value="{{ old('phone') }}" autocomplete="off" oninput="autocompleteContactByPhone(this)" onfocus="autocompleteContactByPhone(this)"></div>
      <div class="field custom-autocomplete"><label>اسم المورد *</label><input type="text" name="name" value="{{ old('name') }}" required autocomplete="off" oninput="autocompleteContactByName(this)" onfocus="autocompleteContactByName(this)"></div>
    </div>
    <div class="row2">
      <div class="field"><label>النشاط</label><input type="text" name="activity" value="{{ old('activity') }}" placeholder="كهربائي / بائع أسمنت / سيراميك..." list="supplier-activities"></div>
    </div>
