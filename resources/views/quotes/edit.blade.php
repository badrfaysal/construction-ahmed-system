...
<form method="POST" action="{{ route('quotes.update', $quote) }}" class="mat-form">
  @csrf
  @method('PUT')
  <div class="form-card" style="max-width:none;margin-bottom:16px; border-radius: 28px; padding: 32px">
    <div class="row2" style="margin-bottom:16px; gap:24px;">
      ...
      <div class="field" style="margin-bottom:0">
        ...
        <input type="text" name="ref" value="{{ old('ref', $quote->ref) }}" required class="neo-big-input">
      </div>
    </div>
    ...
    <div class="row3" style="margin-bottom:16px; gap:24px;">
      <div class="field" style="margin-bottom:0">
        <label>التاريخ *</label>
        <input type="date" name="date" value="{{ old('date', $quote->date->format('Y-m-d')) }}" required class="neo-big-input">
      </div>
      <div class="field" style="margin-bottom:0">
        <label>الحالة</label>
      ...
      <div class="field" style="margin-bottom:0">
        ...
        <input type="number" name="area" value="{{ old('area', $quote->area) }}" min="0" step="0.5" class="neo-big-input" placeholder="0">
      </div>
    </div>
    ...
    <div class="row2" style="margin-bottom:0; gap:24px;">
      <div class="field" style="margin-bottom:0">
        <label>العنوان</label>
        <input type="text" name="address" value="{{ old('address', $quote->address) }}" class="neo-big-input" placeholder="عنوان المشروع...">
      </div>
      <div class="field" style="margin-bottom:0">
        <label>ملاحظات</label>
        <input type="text" name="note" value="{{ old('note', $quote->note) }}" class="neo-big-input" placeholder="أي ملاحظات إضافية...">
      </div>
    </div>
  </div>
